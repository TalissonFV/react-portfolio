  ...
  const formacoes = [
    {
      ...
      certificado:
        "https://www.e-diploma.com.br/Verificar/Autenticidade.aspx?id=394225|7D53C9A1E82784F0DA5B2704E0182A|8386",
    },
  ];
          ...
          {formacoes.map((formacao, index) => (
            <div key={index}>
              <a href={formacao.certificado}>
                <div className="card-style flex items-center gap-6 bg-white">
                  <img
                    src={formacao.logo}
                    className="w-24 h-24 "
